...
*The most commonly observed values for snowfall are 0 mm and NA by far. This is because there are significantly more days in the year with no snow (snow = 0) than days with snow. This dataset also contains extensive missing data, explaining why NA is the second most commonly observed value for snow.*
...
```{r i}
ny_noaa_tidy %>%
  ggplot(aes(x = tmin, y = tmax, group = id, color = id)) +
